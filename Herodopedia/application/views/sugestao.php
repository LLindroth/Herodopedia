...
<html lang="en">
  ...
  <body>
    ...
    <section class="container">
        <form action="../../../artigos/sugerirEdicao/<?=$artigo['cod_artigo']?>/<?=$artigo['titulo'];?>" method="POST">
            <script src="<?php echo base_url();?>ckeditor/ckeditor.js"></script>
            <section class="row container">
                <section class="art-header header-fixed-top">
                    <input type="text" id="inputTitulo" name="titulo" disabled value="<?=strtoupper(str_replace("_", " ",$artigo['titulo']));?>" required autofocus>
                </section>
                <section class="artigo_cont">
                    ...
                    <input id="botao" class="btn btn-lg btn-primary btn-block" type="submit" value="Sugerir">
                </section>
            </section> <!-- /container -->
        </form>
